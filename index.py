...
class LibraryManagementSystem:
    def __init__(self,root):
        ...
        # =======================TitleLabel======================================================================
        lbltitle=Label(self.root,text="LIBRAYRY MANAGEMENT SYSTEM",bg="black",fg="crimson",bd=20,relief=RIDGE,font=("times new roman",50,"bold"),padx=2,pady=6)
    ...
    def add_data(self):
        if self.member_var.get()=="" or self.postcode_var.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="pradeep@123",database="library")
